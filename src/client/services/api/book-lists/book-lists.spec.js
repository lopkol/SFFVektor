...
} = require('../../../../server/dao/book-lists/book-lists');
const {
...
describe('client-side book list related API calls', () => {
  ...
  describe('updateBookList', () => {
    it(
      'updates the book list data correctly',
      withServer(async () => {
  ...
  describe('saveBookList', () => {
    it(
      'creates a new book list with the given data',
      withServer(async () => {
        const userData = generateRandomUser({ role: 'admin' });
        const userId = await createUser(userData);
  ...
  describe('updateBookListFromMoly', () => {
    it(
      'updates the book list data from the moly list',
      withServer(async () => {
