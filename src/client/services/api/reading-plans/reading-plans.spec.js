...
describe('client-side reading plan related API calls', () => {
  ...
  describe('getOwnReadingPlans', () => {
    it(
      'returns null if the user is not a jury member of the book list',
      withServer(async () => {
    ...
    it(
      'returns the reading plans of the user for the given book list',
      withServer(async () => {
        const userData = generateRandomUser({ role: 'user' });
        const userId = await createUser(userData);
  ...
  describe('updateOwnReadingPlans', () => {
    it(
      'updates the reading plans of the user',
      withServer(async () => {
        const userData = generateRandomUser({ role: 'user' });
        const userId = await createUser(userData);
  ...
  describe('getAllReadingPlansForBookList', () => {
    it(
      'returns all reading plans for the given book list, grouped by book',
      withServer(async () => {
